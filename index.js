 ...
 * @instructions This function should be able to take two numbers as arguments
...
function temperatureCtoF(tempC) {
  var tempF = tempC;
  const temper = Math.round(tempC * 9 / 5 + 32);
  return temper;
}
/******------------------------------------------- */
/**
...
function temperatureInF(temp, unit) {
  if (unit === "F") {
    ...
    const result = temperatureCtoF(temp);
    return result + "F";
  };
}
//********************************************** */
 ...
 * @instructions This function takes as its only argument an array
containing strings,
 ...
 * @instructions get3rdCar() should return the string `The is a Land Rover Defender Ice Edition`
